			...
			case 'Input':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							field: _p3,
							validation: _dubert$strengths_friender$StrengthField$isInputValid(_p3)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Validate':
...
var _dubert$strengths_friender$StrengthField$view = F2(
	function (model, ordinal) {
		...
		var error = (!_elm_lang$core$Tuple$first(model.validation)) ? errorText : _MichaelCombs28$elm_mdl$Material_Options$nop;
		return A4(
			...
			model.mdl,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _MichaelCombs28$elm_mdl$Material_Textfield$onInput(_dubert$strengths_friender$StrengthField$Input),
						_1: {
							ctor: '::',
						...
						_0: A4(
							...
							model.mdl,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _MichaelCombs28$elm_mdl$Material_Textfield$onInput(_dubert$strengths_friender$PersonDetail$NameInput),
										_1: {
											ctor: '::',
							...
							_0: A5(
								...
								model.mdl,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _MichaelCombs28$elm_mdl$Material_Button$onClick(_dubert$strengths_friender$PersonDetail$Delete),
											_1: {ctor: '[]'}
										}
									}
								},
									...
									model.mdl,
									{
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _MichaelCombs28$elm_mdl$Material_Button$onClick(_dubert$strengths_friender$PersonDetail$Save),
													_1: {ctor: '[]'}
												}
											}
										}
			...
			return A5(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _MichaelCombs28$elm_mdl$Material_Menu$onSelect(_dubert$strengths_friender$Main$ToggleViewState),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
					...
					model.mdl,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _MichaelCombs28$elm_mdl$Material_Button$onClick(_dubert$strengths_friender$Main$Create),
									_1: {
										ctor: '::',
...
if (typeof _dubert$strengths_friender$Main$main !== 'undefined') {
    _dubert$strengths_friender$Main$main(Elm['Main'], 'Main', undefined);
}
